...
import com.exam.domain.vo.Item;
...
public class ItemController {
    ...
    final MultiQuestionService multiQuestionService;

    final FillQuestionService fillQuestionService;

    final JudgeQuestionService judgeQuestionService;
